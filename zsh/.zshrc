...
# File browsing with preview - use 'ff' command
alias ff='fzf --preview "fzf-preview.sh {}" --preview-window=right:50%:wrap'

# Configure preview for Ctrl-T (file finder)
export FZF_CTRL_T_OPTS='--preview "fzf-preview.sh {}" --preview-window=right:50%:wrap'

# Configure preview for Alt-C (directory finder)
